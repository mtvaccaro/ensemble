  ...
  return (
    <div className="space-y-4 relative">
      ...
      <div className="space-y-6 px-4 relative">
        ...
        {!selectionStart && (
          <div className="sticky bottom-4 left-0 right-0 mx-auto w-fit z-10 animate-in fade-in duration-300">
            <div className="bg-purple-600 text-white px-4 py-2.5 rounded-lg shadow-lg border border-purple-500 flex items-center gap-2">
